              ...
              <div className="author">
                ...
                <div className="auth-details">
                  <Avatar {...stringAvatar(questionData?.user?.displayName
                    ...
                    : questionData?.user?.email ? (questionData?.user?.email).split('@')[0] : "SO")} />
                  <p>
                    {questionData?.user?.displayName
                      ? questionData?.user?.displayName
                      : questionData?.user?.email ? (questionData?.user?.email).split('@')[0] : "Stack Overflow"}
                  </p>
                </div>
              </div>
              {/* Comments */}
                      ...
                      <p key={_qd?._id}>
                        ...
                        <span>
                          - {_qd?.user?.displayName
                            ? _qd?.user?.displayName
                            : _qd?.user?.email ? (_qd?.user?.email).split('@')[0] : "Stack Overflow"}
                        </span>{" "}
                        {"    "}
                        <small>
                  ...
                  <div className="author">
                    ...
                    <div className="auth-details">
                      <Avatar {...stringAvatar(_q?.user?.displayName
                        ? _q?.user?.displayName
                        : _q?.user?.email ? (_q?.user?.email).split('@')[0] : "SO")} />
                      <p>
                        {_q?.user?.displayName
                          ? _q?.user?.displayName
                          : _q?.user?.email ? (_q?.user?.email).split('@')[0] : "Stack Overflow"}
                      </p>
                    </div>
                  </div>
                </div>
